...
<section class="main">
<div align="justify" style="margin-left:30px;margin-right:30px; margin-top:20px;"><?=$linhaAltit['texto']?></div>
<p align="center" style="margin-top:30px;"><img src="http://www.agescritoriodearte.com.br/images/<?=$linhaAltit['foto']?>" width="90%">
