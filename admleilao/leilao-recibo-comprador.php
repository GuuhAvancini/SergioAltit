...
<table width="100%" border="0">
  <tr>
    ...
    <td width="88%"><div id="tituloRelatorio" align="center">Recibo de Arrematação<br />Leilão: <?=$linha['idLeilaoN']?> - <?=$linha['descricao']?> - <?=$linha['dataLeilao']?> - <?=$linha['horario']?></div></td>
  </tr>
</table>
<br />
<?
...
<table width="324" border="1" cellpadding="5" cellspacing="0" bordercolor="#FFFFFF">
  ...
  <tr>
    <td bgcolor="#F8F8F8">Total a Pagar:</td>
    <td bgcolor="#F8F8F8">R$ 
      <? echo number_format($ValorLiquido, 2, ',', '.');
	  ?></td>
  </tr>
</table>
<p><span style="font-size:16px">Sergio Altit Leilões</span>, credenciado na  JUCESP  sobra a matricula 440, recebemos do Sr(a) <strong>
  <?=$linhaEc['nome']?>
</strong> a import&acirc;ncia de R$ 

<?=number_format($ValorLiquido, 2, ',', '.')?> (<?=clsTexto::valorPorExtenso(number_format($ValorLiquido, 2, ',', '.'), true, false);?>) referente aos pagamentos do(s) iten(s) acima relacionado(s).</p>
<p>&nbsp;</p><p>&nbsp;</p>
<table width="100%">
<tr>
...
<p><br /><br /><br />Data: _______/_______________/_________
</p><p>&nbsp;</p><p>&nbsp;</p>
<p class="break"></p>
<? }}?>
</body>
