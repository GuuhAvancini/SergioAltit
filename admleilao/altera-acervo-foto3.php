...
$query = mysql_query("UPDATE `acervo` SET `foto3` = '".$nome_final."' WHERE `idPeca` = '".$_GET['idPeca']."' ") or die(mysql_error());
...
$linhalog = "- ".date('d/m/Y - H:m:s')." - Usuário: ".$_SESSION['usuarioNome']." - Alterou a foto da pe�a: ".$linhaEc['descricao'].".\n";
