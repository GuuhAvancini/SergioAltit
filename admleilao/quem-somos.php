...
$querySt = "Select * from website where codigoCliente = '".$_SESSION['codigoCliente']."' and idPagina = '2'";
...
<div id="conteudo" style="margin-bottom:50px;">
    ...
    <p>&nbsp;</p><p>&nbsp;</p>
    <p>Editar texto - Quem Somos:</p>
    <table width="100%" border="0">
      <tr>
        <td width="61%"><form id="form2" name="form2" method="post"  action="altera-website-quemsomos.php">
      ...
      <br /><input type="submit" value="Alterar Página" name="new_button" id="new_button" style="margin-left:-1px;" />
        ...
        <td width="39%" align="left"><form  action="altera-website-quemsomos-foto.php" method="post" enctype="multipart/form-data" name="form2" id="form2">
        <img src="../images/<?=$linhaSt['foto']?>" width="160" height="225"><br />
