...
$query = mysql_query("UPDATE `website` SET `foto` = '".$nome_final."', link = '".$_POST['link']."', idLeilao = '".$_POST['idLeilao']."' WHERE `idPagina` = '5' and codigoCliente = '".$_SESSION['codigoCliente']."' ") or die(mysql_error());

$linhalog = "- ".date('d/m/Y - H:m:s')." - Usuário: ".$_SESSION['usuarioNome']." - Alterou a imagem da Home do site.\n";
escrevelog($linhalog,$_SESSION['codigoCliente']);



header("Location: web-site.php?op=altok");
?>
