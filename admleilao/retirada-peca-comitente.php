...
<div id="conteudo" style="margin-bottom:50px;">
  ...
  <tr>
    ...
    <div id="conteudo-home-busca-cadastros" style="display:block !important; margin-top:200px !important; ">
      ...
      <form id="form1" name="form1" method="post" action="retirada-peca-comitente-recibo.php?idCadastro=<?=$_GET['idCadastro']?>" target="_blank" onsubmit="return enviaConsig()">
    ...
    <? }?>
    <tr bgcolor="#fffdea"  >
        <td colspan="6" style="border-bottom:none !important; border-right:none !important;" align="right"><input type="submit" value="Gerar Retirada" name="new_button" id="new_button"  style="float:right;" /></td>
      </tr></table>
    </form>
    </div>
    </div>
