...
<div id="conteudo" style="margin-bottom:50px;">
    ...
    <p>&nbsp;</p>
    <p>Editar imagem da Home:</p>
    <form id="form2" name="form2" method="post"  action="altera-website-foto-capta.php" enctype="multipart/form-data">
