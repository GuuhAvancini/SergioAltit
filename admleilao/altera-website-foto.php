...
$query = mysql_query("UPDATE `website` SET `foto` = '".$nome_final."', link = '".$_POST['link']."', idLeilao = '".$_POST['idLeilao']."' WHERE `idPagina` = '1' and codigoCliente = '".$_SESSION['codigoCliente']."' ") or die(mysql_error());
