...
$linhalog = "- ".date('d/m/Y - H:m:s')." - Usuário: ".$_SESSION['usuarioNome']." - Gerou excel dos comitentes.\n";
escrevelog($linhalog,$_SESSION['codigoCliente']);


$arquivo = "comitentes.xls";
...
<table width="100%" border="1" cellpadding="5" cellspacing="0"  style="font-size:12px;">
  ...
  <?
	  $queryLotes = "Select * from comitentes where codigoCliente = '".$_SESSION['codigoCliente']."' order by nome asc";
