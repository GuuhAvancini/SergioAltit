...
$query = mysql_query("UPDATE `website` SET `foto` = '".$nome_final."' WHERE `idPagina` = '2' and codigoCliente = '".$_SESSION['codigoCliente']."' ") or die(mysql_error());

$linhalog = "- ".date('d/m/Y - H:m:s')." - Usuário: ".$_SESSION['usuarioNome']." - Alterou a imagem da Quem Somos do site.\n";
escrevelog($linhalog,$_SESSION['codigoCliente']);



header("Location: quem-somos.php?op=altok");
?>
