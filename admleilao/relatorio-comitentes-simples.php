...
<table width="100%" border="0">
  <tr>
    ...
    <td width="88%"><div id="tituloRelatorio" align="center">RELATÓRIO COMITENTES SIMPLES<br />Leilão: <?=$linha['idLeilaoN']?> - <?=$linha['descricao']?> - <?=$linha['dataLeilao']?> - <?=$linha['horario']?></div></td>
  </tr>
</table>
<br />
<table width="100%" border="1" cellpadding="5" cellspacing="0"  style="font-size:12px;">
  <tr>
    <td width="26%" align="center">Nome do Comitente</td>
    <td width="32%">&nbsp;</td>
