...
function enviaConsig(){
 ...
 location.href = "view-comitente.php?idCadastro=<?=$_GET['idCadastro']?>";
...
<div id="conteudo" style="margin-bottom:50px;">
  ...
  <tr>
    ...
    <div id="conteudo-home-busca-cadastros" style="display:block !important; margin-top:200px !important; ">
      ...
      <form id="form1" name="form1" method="post" action="consignacao.php?idCadastro=<?=$_GET['idCadastro']?>" target="_blank" onsubmit="return enviaConsig()">
    ...
    <? }?>
    <tr bgcolor="#fffdea"  >
        <td colspan="6" style="border-bottom:none !important; border-right:none !important;" align="right"><p>
          Percentual: <input type="text" name="percentual" id="percentual" value="20%" width="30" style="width:50px !important;"> -  Prazo Pagamento: <input type="text" name="prazo" id="prazo" value="15 dias úteis" width="100" style="width:100px !important;">
          <input name="tipoConsig" type="radio" id="radio" style="width:30px;" value="ag" checked="checked" />AG Escritório de Arte <input type="radio" name="tipoConsig" id="radio" value="leiloeiro" style="width:30px;" />Leiloeiro 
        </p>  
          <p>Tempo de vigência: <input type="text" name="vigencia" id="vigencia" value="180" width="30" style="width:50px !important;"> dias - Outros serviços: <input type="text" name="outros" id="outros" width="30" style="width:250px !important;"> </p>
          <input type="submit" value="Gerar Consignação" name="new_button" id="new_button"  style="float:right;" /></td>
      </tr></table>
    </form>
    </div>
    </div>
