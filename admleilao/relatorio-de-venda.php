...
$linhalog = "- ".date('d/m/Y - H:m:s')." - Usuário: ".$_SESSION['usuarioNome']." - Visualizou o relatório de venda.\n";
...
<table width="100%" border="0" style="font-size:12px;">
  <tr>
          <td width="5%" valign="top">LOTE: <br />            <?=$linhaLotes['lote']?><?=$linhaLotes['loteExt']?></td>
          <td width="5%" valign="top"><img src="fotos/<? 
	if ($linhaAc['foto'] == ""){
		echo "1400782209_photo.png";
	}else{
		echo $linhaAc['foto'];}?>" width="52" height="56" /></td>
          <td width="51%" valign="top">Descrição do Lote:<br />
          <?=$linhaAc['descricao']?></td>
          <td width="39%" valign="top">Arrematado:<br />
            <?=$linhaLotes['cartela']?> - <?=$linhaEc['nome']?></td>
        </tr>
        <tr>
