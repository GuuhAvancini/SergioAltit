...
<h2 style="margin:20px;">Leilões:</h2>
			...
			if($linhaSt['link'] == "sim"){
			?>
          <p align="center" style="margin-left:15px; margin-right:15px;"><img src="../images/<? 
	if ($linhaSt['foto'] <> ""){
	echo $linhaSt['foto'];
	}else{
	echo "1400782209_photo.png";
            ...
            <?
	  $queryCs = "Select * from leiloes where website = 'sim' and convite <> '' and estatus = 'Pregão' and siteAg = '1' order by data desc";
      ...
      //$linha = mysql_fetch_array($resultadoCs);
            ...
            <p align="center" style="margin-left:15px; margin-right:15px;"><a href="view-leilao.php?id=<?=$linha['idLeilao']?>"><img src="../images/<?=$linha['convite']?>"  width="90%"  /></a></p>
                ...
                <p><input name="" type="submit" value="Catálogo Completo" style="width:150px;margin-left:15px; margin-right:15px; margin-top:20px;" onclick="location.href='view-leilao.php?id=<?=$linha['idLeilao']?>'"> <? if($linha['catalogopdf'] <> ""){?><input name="" type="button" value="Catálogo em PDF" style="width:150px;" onClick="window.open('../convites/<?=$linha['catalogopdf']?>');"><? }?></p>
          ...
          <p align="center"  style="margin-left:15px; margin-right:15px; margin-top:20px;">
                ...
                ?>
                    <div id="imgArtista" align="center">
                        <a href="view-leilao.php?id=<?=$linha['idLeilao']?>"><img src="../images/<?=$linha['convite']?>" width="90%" style="margin:5px;" /></a>
