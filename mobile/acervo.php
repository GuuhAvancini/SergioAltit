...
<section class="main">
<h2 align="center">Peças disponíveis em nosso acervo:</h2>
            <form action="?op=busca" id="form1" name="form1" method="post">
            <input name="busca" type="text" style="width:90%; margin-left:10px;;" placeholder="Buscar artista..." style="float:left; " /> <input type="image" src="../images/if_11_Search_106236.png" id="butBusca" style="float:left; " >
            </form>
            <p align="center" style="width:1200px; margin-bottom:40px;">
                ...
                ?>
                    <div id="imgArtista" style="margin-bottom:20px;" align="center">
                        <a href="acervo-visualizar.php?id=<?=$linha['idPeca']?>"><img src="../admleilao/fotos/<?=$linha['foto']?>" width="90%" style="margin:5px;" /></a>
                        <div id="tituloArtistas" style="width:90%;"><?
            ...
            <? }else{?>
          <p align="center" style="height:90px; width:350px; background-color:#FFF; margin-top:50px; padding:10px; margin-left:30px;"><em>Não possuímos obras deste artista no momento, se você tiver interesse em comprar ou vender, entre em contato conosco pelo número: (11) 3721-9676</em></p>
            <? }?>
