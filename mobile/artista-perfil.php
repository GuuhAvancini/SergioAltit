...
<?
	  ...
	  $linha = mysql_fetch_array($resultadoCs);
            ...
            <p align="center" style="margin-top:30px;"><img src="../../images/<?=$linha['foto']?>"  width="90%" /><p>
      ...
      <p><br />
        ...
        <h2 style="margin-left:15px; margin-right:15px;">Obras no acervo:</h2>
        <p align="center" style="width:90%; margin-bottom:40px;margin-left:15px; margin-right:15px;">
				<?
                ...
                ?>
                    <div id="imgArtista" style="margin-left:15px; margin-right:15px;">
            ...
            <? }else{?>
          <p align="center" style="margin-left:15px; margin-right:15px;"><em>No momento não temos nenhuma obra do artista em nosso acervo, entre em contato...</em></p>
            <? }?></td>
